...
public class UserValidator {
    public static void validateName(String name) {
        ...
        if (!name.matches(regex)) {
            throw new UserValidationException("Bad name.");
        }
    }
    ...
    public static void validateSurname(String surname) {
        ...
        if (!surname.matches(regex)) {
            throw new UserValidationException("Bad surname.");
        }
    }
    ...
    public static void validateLogin(String login) {
        ...
        if (!login.matches(regex)) {
            throw new UserValidationException("Bad login");
        }
    }
    ...
    public static void validateEmail(String email) {
        ...
        if (!email.matches(regex)) {
            throw new UserValidationException("Bad e-mial.");
        }
    }
    ...
    public static void validatePhoneNumber(String phoneNumber) {
        ...
        if (!phoneNumber.matches(regex)) {
            throw new UserValidationException("Bad phone numer.");
        }
    }
